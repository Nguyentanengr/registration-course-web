...
public enum CodeResponse {
    ...
    PHASE_TYPE_IS_BLANK(9071, HttpStatus.CONFLICT, "Registration phase type cannot be blank"),
    PHASE_NAME_IS_BLANK(9069, HttpStatus.CONFLICT, "Registration phase name cannot be blank"),
