...
public enum CodeResponse {
    ...
    SCHEDULE_CONFLICT(9131, HttpStatus.CONFLICT, "Trùng lịch học"),
    SESSION_IS_FULL(9129, HttpStatus.CONFLICT, "Lớp học phần đã hết số lượng đăng ký"),
    REGISTRATION_NO_OPEN(9127, HttpStatus.CONFLICT, "Đợt đăng ký đã đóng"),
    EXCEEDS_MAXIMUM_CREDITS(9125, HttpStatus.CONFLICT, "Bạn đã đăng ký đủ số lượng tín chỉ cho học kì này"),
    INVALID_SESSION_YEAR(9123, HttpStatus.CONFLICT, "Niên khóa, học kỳ này đã xảy ra rồi"),
    PLACE_NOT_AVAILABLE(9121, HttpStatus.CONFLICT, "This place is not available"),
